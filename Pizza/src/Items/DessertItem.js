...
class DessertItem extends React.PureComponent{
    ...
    addToCart = () => {
        let addedItemInfo = {key:this.props.info.key, name:this.props.info.name, price:this.props.info.price, status:'exist'}
...
const mapStateToProps = function(state){
  ...
  export default connect(mapStateToProps)(DessertItem);